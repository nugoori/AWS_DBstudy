...
--
-- Host: portfolio.cgdrwidry3wi.ap-northeast-2.rds.amazonaws.com    Database: androg
-- ------------------------------------------------------
...
CREATE TABLE `address_tb` (
  ...
  `address_detail` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `address_sido` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `address_sigungu` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `address_bname` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `address_zonecode` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `ponenumber` varchar(45) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `adminreview_tb` (
  ...
  `review_content` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `cart_tb` (
  ...
  `size_name` varchar(45) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `inquiry_resp_tb` (
  ...
  `answer` varchar(200) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `inquiry_tb` (
  ...
  `inquiry_category` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `inquiry_content` varchar(200) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `product_tb` (
  ...
  `product_img` varchar(900) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `role_tb` (
  ...
  `role_name` varchar(45) CHARACTER SET big5 NOT NULL,
  PRIMARY KEY (`role_id`)
...
CREATE TABLE `user_tb` (
  ...
  `password` varchar(200) CHARACTER SET big5 NOT NULL,
...
-- Dump completed on 2023-07-20  9:27:04
